# kadr — універсальний медіаконвертер у браузері

**Дата:** 2026-08-19
**Статус:** затверджено, готово до планування
**Домен:** `kadr.dobrovolskyi.com.ua`
...
| Субдомен `kadr.dobrovolskyi.com.ua` | рішення власника; SEO-стеля свідомо прийнята нижчою |
...
Моделі в Node кешуються в `~/.cache/kadr/models/`.
...
```
kadr.dobrovolskyi.com.ua   CNAME →  <проєкт>.pages.dev
```
...
**Cloudflare R2** — публічний бакет на `models.kadr.dobrovolskyi.com.ua`.
