...
> Після огляду коду шар без повороту кладеться просто на сітку пікселів,
> без тригонометрії: 9,6 мс замість 10,9, а заразом зникла напівпрозора
> облямівка, яку дробовий центр давав при непарній ширині (204 змішані
> пікселі на шарі 51×51 — тепер нуль).
